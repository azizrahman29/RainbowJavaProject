...
public class ConstructorEmployee {
	...
	// data members/fields/variables
		...
		ConstructorEmployee(int employeID, String employeName, String employePosition, String employerName, String employeeLocation,
		...
		public static void main(String[] args) {
			...
			ConstructorEmployee employee = new ConstructorEmployee (101, "Ahmad", "Manager", "Wells Fargo", "Stafford, VA", 67000 );
